...
function IndividualPage(props) {
  ...
  return (
    ...
    <div key={props.pageId}>
      <Banner original_title={data.original_title} id={id}  img={`${baseImgUrl}${data.backdrop_path}`  } title={data.original_title || data.name} description={data.overview}>hi</Banner>
